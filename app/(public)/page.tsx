        ...
        <div className="flex flex-col">
                ...
                <div className="max-w-4xl mx-auto animate-fade-up">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            ...
                            className="px-8 py-4 bg-blue-500 text-white border border-blue-400 rounded-lg font-bold text-lg hover:bg-blue-400 transition-all flex items-center justify-center gap-2"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <section className="py-24 px-4 bg-white">
                <div className="max-w-6xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">Tại sao chọn SpaceShare?</h2>
            ...
            <section className="py-24 px-4 bg-slate-50">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-slate-900">Cách thức hoạt động</h2>
            ...
            <section className="bg-blue-600 py-24 px-4 text-center text-white">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">Sẵn sàng bắt đầu?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="/dashboard/listings/new"
                            className="px-8 py-4 bg-blue-500 text-white border border-blue-400 rounded-lg font-bold text-lg hover:bg-blue-400 transition-all"
                        >
                            Đăng tin miễn phí
                        </Link>
                    </div>
