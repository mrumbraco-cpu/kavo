            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 h-8">
                ...
                <div className="flex items-center p-0.5 bg-gray-100 rounded-lg h-full">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold transition-all cursor-pointer h-full ${layout === 'list' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-400 hover:text-gray-600'
                            }`}
                    >
