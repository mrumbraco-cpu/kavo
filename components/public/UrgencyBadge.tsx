...
const UrgencyBadge: React.FC<UrgencyBadgeProps> = ({ unlockCount, threshold }) => {
    ...
    if (isRare) {
        return (
            <div className="flex items-center gap-4 px-6 py-4 rounded-2xl border border-gray-200 bg-rose-50 shadow-sm mb-4">
    ...
    return (
        <div className="flex items-center gap-4 px-6 py-4 rounded-2xl border border-gray-200 bg-white shadow-sm mb-4">
            ...
            <div className="flex-grow">
                ...
                <p className="text-sm text-gray-500 mt-0.5">
                    Hãy mở khóa để liên hệ chủ ngay
                </p>
            </div>
        </div>
    );
